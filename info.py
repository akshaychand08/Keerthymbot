...
BOT_TOKEN = environ.get('BOT_TOKEN', '7923487885:AAEGwuNAJ5a6aLLmNC6su7HO-1XQIeeR19c')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "Bot Start 💖")

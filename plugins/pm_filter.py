...
async def lang_next_page(bot, query):
    ...
    btn = [[InlineKeyboardButton(text=f"⚡️ {get_size(file.file_size)}» {remove_username(file.file_name)}",callback_data=f'file#{grp_id}_{file.file_id}')] for file in files]
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                await query.answer(url=f"https://t.me/{temp.U_NAME}?start={ident}_{grp_id}_{file_id}")
                return
            elif settings['botpm']:
                await query.answer(url=f"https://t.me/{temp.U_NAME}?start={ident}_{grp_id}_{file_id}")
                return
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟ', callback_data='autofilter')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/+LDtKhpufANk1MjJl'),
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("Your Not Admin ⚠️", show_alert=True)
        ...
        dict_info = {"town": "Examples 👇👇\n\nMoney Heist\nMoney Heist S01\nMoney Heist S03 Complete, Combined\nMismatched S03\nMismatched S03 Combined\nThukra ke mera pyaar S01 E07\n\nइस फॉरमॅट को देखकर खोज करे.👆👆\n\ndon't type season, seasion 4,5, Send All Season", "nah":"Not available in Hindi", "nak":"Not available in Kannada", "tomn":"Example 👇👇\n\nPushpa 2: The Rule\nPushpa 2: The Rule Hindi (add your language)\nThe Martian 2015\nThe Martian Hindi (add your language)\n\nइस फॉरमॅट को देखकर खोज करे.👆👆\n\ndon't add Hindi dab, Hindi language, movie hindi dubbed", "natm":"Not available in Tamil", "nam":"Not available in Malayalam", "nak":"Not available in kannada", "nat":"Not available in Telugu", "simd":"Send imdb link\n\nClick here to generate  imdb link 🔻", "au":"Already uploaded ✅ \n\n Go to Google and check your spelling  <b><a href=https://www.google.com>𝐆𝐨𝐨𝐠𝐥𝐞</a></b>", "up":"Updated  ✅", "not":"Not released OTT yet", "nry":"Not released yet", "na":"Not available"}
